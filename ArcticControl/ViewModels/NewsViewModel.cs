...
public class NewsViewModel : ObservableRecipient, INavigationAware
{
    private Uri _source = new("https://game.intel.com/story/intel-arc-graphics/");
    ...
    public NewsViewModel(IWebViewService webViewService)
    {
